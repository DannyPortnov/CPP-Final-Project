...
protected:
	...
	std::set<Song*, CompareSongsByName> m_songs; // uses to store all songs in the playlist in alphabetical order (use it for play). 
...
public:
	...
	std::set<Song*, Playlist::CompareSongsByName> get_songs();
